# Welcome to MediSend!
MediSend is our system for logging and sharing medicine, designed to reduce wastage and improve access to medicine in places where medicine supplies are limited for the PA Raspberry Pi compettion 2026.
# Running MediSend
